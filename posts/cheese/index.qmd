...
We plot the average fat content by texture, limiting the chart to the top 15 textures for clarity. We also wrap long texture names and rotate the x-axis labels to improve readability.
...
top_textures <- avg_fat_by_texture %>% top_n(15, avg_fat_content)
...
ggplot(top_textures, aes(x = reorder(texture, avg_fat_content), y = avg_fat_content)) +
  ...
  coord_flip() +  
  labs(title = "Top 15 Average Fat Content of Cheeses by Texture", 
       x = "Texture", 
       y = "Average Fat Content (%)") +
