...
We plot the average fat content by texture, limiting the chart to the top 50 textures for clarity. We also wrap long texture names and rotate the x-axis labels to improve readability.
